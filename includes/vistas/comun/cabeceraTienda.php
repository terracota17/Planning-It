<?php
    ...
    function añadirProducto() {
        ...
        if (isset($_SESSION['login'])){
            if (!isset($_SESSION['esAdmin']) || !$_SESSION['esAdmin']) { 
                ...
                return "<li><a href='../tienda/gestionarProductos.php'>Gestionar Productos</a></li>";
            }
        }
    ...
    function compruebaObjetosCarrito(){
        ...
        if( $productos > 0){
            ...
            return "<a href = 'verPedido.php?Ver+Pedido=Ver+Pedido&idPedido={$idPedido}'><i class='fa-solid fa-cart-shopping'><span class ='dot'><sup>{$productos}</sup></span></i></a>";
        }
        else {
            return '<a href = "misCompras.php?Mis+Compras=Mis+Compras"><i class="fa-solid fa-cart-shopping"></i></a>';
        }
    }
    }
